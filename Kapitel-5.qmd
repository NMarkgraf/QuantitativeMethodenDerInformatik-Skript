...
Um die totale Wahrscheinlichkeit für die Uhrzeit "`Lunch`" zu bestimmen, können Sie die einzelnen bedingten Wahrscheinlichkeiten multipliziert mit den jeweiligen Wahrscheinlichkeiten (Ereignisse $B_k, k=1, \dots,K$[^Formal müssen die Ereignisse $B_k$ überschneidungs frei sein und die Wahrscheinlichkeiten in der Summe eins ergeben.], welche die Bedingungen stellen, auf addieren:
