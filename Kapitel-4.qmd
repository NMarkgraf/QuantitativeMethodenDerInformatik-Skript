...
@tbl-Data zeigt einen exemplarischen Datensatz. Ein Datensatz ist meist wie ein Tabellenkalkulationsblatt aufgebaut. Daten werden häufig auch in Formaten abgespeichert, die von Tabellenkalkulationsprogrammen (wie Excel, Numbers o. ä.) gelesen werden können.
...
Dass Sie bei der Auswahl der Kovariablen aufpassen müssen, zeigt @fig-UCBEins, in der es um Zulassungen an der University of California Berkeley im Zusammenhang mit dem Geschlecht geht (Bickel, Hammel und O'Connell @bickel1975).
...
::: column-margin
[![Gelegenheitsstichproben erreichen nur die niedrig hängenden Früchte. &copy;  J. B. Landers, Bildunterschrift  L. Lesser](causeweb-images/cartoon0118.jpg){}](https://www.causeweb.org/cause/caption-contest/january/2018/results)
:::
...
#| caption: "Gelegenheitsstichprobe vs. Zufallsstichprobe"
...
#| caption: Griechische Buchstaben in der Statistik
#| echo: false
#| warning: false
library(knitr)
#library(kableExtra) ## NICHT NUTZEN!!!
...
```{r fig = TRUE}
#| caption: "Beobachtungsstudie vs. Experiment"
