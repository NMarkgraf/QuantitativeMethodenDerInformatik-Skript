...
::: column-margin
[![Gelegenheitsstichproben erreichen nur die niedrig hängenden Früchte. \copyright\xspace J.\,B. Landers, Bildunterschrift  L. Lesser](causeweb-images/cartoon0118.jpg){}](https://www.causeweb.org/cause/caption-contest/january/2018/results)
:::
...
```{r fig = TRUE, echo = FALSE, fig.width = 7, fig.asp = 0.5, out.width = "10cm"}
